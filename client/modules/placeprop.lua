...
function PropPlacer(outputitem, prop, inputitem)
    ...
    while true do
        ...
        if PromptHasHoldModeCompleted(SetPrompt) then
            ...
            TriggerEvent('qc-farming:client:plantnewseed', outputitem, inputitem, PropHash, pPos, heading )
...
RegisterNetEvent('qc-farming:client:preplantseed', function( outputitem, prop, inputitem )
